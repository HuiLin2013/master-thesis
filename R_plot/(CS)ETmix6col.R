data <- read.table("(CS)ETmix6col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="(CS)ETmix6Col.png", height = 1000, width = 1300, bg = "white")
...
title(main="Execution Time_Mix of Numbers and Strings_6Columns (Case Study)", col.main="red", font.main=6)
