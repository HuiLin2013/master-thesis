data <- read.table("(CS)ETmix8col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="(CS)ETmix8Col.png", height = 1000, width = 1300, bg = "white")
...
title(main="Execution Time_Mix of Numbers and Strings_8Columns (Case Study)", col.main="red", font.main=6)
