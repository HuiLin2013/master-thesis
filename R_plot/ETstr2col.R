data <- read.table("ETstr2col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="ETstr2Col.png", height = 1000, width = 1300, bg = "white")
plot(data$HTML5_Loading, type = "o", col = plot_colors[1], pch=15, lty=1, ylim=c(0,max_y), axes=FALSE, ann=FALSE)
axis(1, at=1:5, lab=c("2000", "4000", "6000", "8000", "10000"))
axis(2, las=1, at=1000*0:max_y, cex.axis = 0.8)
...
title(main="Execution Time_Strings_2Columns", col.main="red", font.main=6)
title(xlab= "Number of rows", col.lab="red")
title(ylab= "Execution Time (ms) for Strings", col.lab="red")
