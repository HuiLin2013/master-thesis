data <- read.table("(CS)ETstr10col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="(CS)ETstr10Col.png", height = 1000, width = 1300, bg = "white")
...
title(main="Execution Time_Strings_10Columns (Case Study)", col.main="red", font.main=6)
