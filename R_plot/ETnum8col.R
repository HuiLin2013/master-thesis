data <- read.table("ETnum8col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="ETnum8Col.png", height = 1000, width = 1300, bg = "white")
...
title(main="Execution Time_Numbers_8Columns", col.main="red", font.main=6)
