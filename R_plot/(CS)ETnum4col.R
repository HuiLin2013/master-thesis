data <- read.table("(CS)ETnum4col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="(CS)ETnum4Col.png", height = 1000, width = 1300, bg = "white")
...
title(main="Execution Time_Numbers_4Columns (Case Study)", col.main="red", font.main=6)
