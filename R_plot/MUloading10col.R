data <- read.table("MUloading10col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="MUloading10col.png", height = 1000, width = 1450, bg = "white")
...
title(main="Memory Usage_Loading_10Columns", col.main="red", font.main=6)
