data <- read.table("ETmix6col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="ETmix6Col.png", height = 1000, width = 1450, bg = "white")
...
title(main="Execution Time_Mix of Numbers and Strings_6Columns", col.main="red", font.main=6)
