data <- read.table("ETstr4col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="ETstr4Col.png", height = 1000, width = 1300, bg = "white")
...
title(main="Execution Time_Strings_4Columns", col.main="red", font.main=6)
