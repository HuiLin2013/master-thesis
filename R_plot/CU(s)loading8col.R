data <- read.table("CU(s)loading8col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="CU(s)loading8col.png", height = 1000, width = 1450, bg = "white")
...
title(main="CPU Usage (s)_Loading_8Columns", col.main="red", font.main=6)
