data <- read.table("PCloading2col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="PCloading2col.png", height = 1000, width = 1450, bg = "white")
...
title(main="Power Consumption (mw)_Loading_2Columns", col.main="red", font.main=6)
