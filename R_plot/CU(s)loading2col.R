data <- read.table("CU(s)loading2col.txt", header = TRUE)

max_y <- max(data)
plot_colors <- c("black", "blue", "red4")
png(filename="CU(s)loading2col.png", height = 1000, width = 1450, bg = "white")
...
title(main="CPU Usage (s)_Loading_2Columns", col.main="red", font.main=6)
